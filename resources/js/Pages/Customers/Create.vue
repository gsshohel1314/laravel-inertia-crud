...
<template>
    <Head>
        ...
        <meta head-key="description" name="description" content="This is inertia app customer create page" />
    </Head>
    ...
    <section class="mx-auto max-w-screen-xl px-4 py-16">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-8">
            ...
            <Form class="space-y-6" :action="route('customers.store')" method="POST" #default="{ errors, processing }">
