...
const app_name = onMounted(() => {
    console.log('App Name Log: ', page.props.appName);
})

</script>

<template>
    <header class="sticky top-0 z-30 border-b bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <nav class="mx-auto flex max-w-screen-xl items-center justify-between px-4 py-3">
            ...
            <ul class="hidden items-center gap-8 text-sm md:flex">
                <li>
                    <Link :href="route('home')" class="text-gray-700 transition-colors hover:text-blue-600">Home</Link>
                </li>
                <li>
                    <Link :href="route('about')" class="text-gray-700 transition-colors hover:text-blue-600">About</Link>
                </li>
                <li>
